...
Perspectiv is sold as a one-time license for the term you pick. No monthly billing, no auto-renewal, no surprise charges. When your term ends, your license expires and you decide whether to renew.

| Plan | Devices (full monitoring) | ICMP-only | 1-year (15% off) | 2-year (25% off) |
|---|---|---|---|---|
| **Starter** | 100 | unlimited | $4,070 | $7,182 |
| **Professional** | 250 | unlimited | $9,170 | $16,182 |
| **Business** | 500 | unlimited | $16,310 | $28,782 |
| **Enterprise** | 1,000 | unlimited | $28,550 | $50,382 |
| **Scale** | 1,000+ | unlimited | custom | custom |

> **Discounts are off the equivalent monthly rate × term.** 1-year locks in 15% off; 2-year locks in 25% off. 3+ year terms, multi-site, multi-tenant, and government pricing on the Scale tier — talk to us.
...
Numbers above are based on publicly listed SolarWinds pricing for a 500-node Hybrid Cloud Observability Essentials deployment plus typical SQL Server Enterprise + Windows licensing + dedicated server hardware sized to actual production SolarWinds RAM observations (160+ GB observed on real customer deployments — and not just at 500-node scale; the same RAM footprint shows up on installs monitoring fewer than 250 devices). Your mileage may vary.

**One thing worth flagging on the SolarWinds side:** customers with mid-sized fleets (200–300 devices) frequently end up on the 500-node tier anyway, because features they actually need are gated behind it — paying for capacity they'll never use. Perspectiv puts every feature in every tier. Pick the tier that matches your fleet size, not the one that unlocks the module you need.
